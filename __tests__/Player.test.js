...
test('gets invenrtory from player or returns false', () => {
    const player = new Player('Dave');

    expect(player.getInventory()).toEqual(expect.any(Array));
    // simulating an empty array to test results of an empty inventory
    player.inventory = [];
...
test("get player's health value", () => {
    const player = new Player('Dave');
    // stringContaining will give us flexibility to change how the plaer's health will be displayed
